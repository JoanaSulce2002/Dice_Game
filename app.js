...
window.addEventListener("load", function () {
  ...
  function init() {
    ...
    randomNumbers = [0, 0];
    currentPlayer = 0;
    (isPlaying = true), (maxScore = 100), (lastDicesNumbers = [0, 0]);
    ...
    document
      ...
      .classList.remove("active-player", "victory");
    document
  ...
  $rollDiceBtn.addEventListener("click", function () {
    if (isPlaying) {
      ...
      if (
        randomNumbers[0] !== 1 &&
        !(randomNumbers[0] === 6 && lastDicesNumbers[0] === 6) &&
        randomNumbers[1] !== 1 &&
        !(randomNumbers[1] === 6 && lastDicesNumbers[1] === 6)
      ) {
  ...
  $holdScoreBtn.addEventListener("click", function () {
    if (isPlaying) {
      ...
      document.querySelector(
        "#player-" + currentPlayer + "-global"
      ).textContent = globalScore[currentPlayer];
